...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page/</span>Edite Products</h4>

    <!-- Basic Layout -->
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Edite Products</h5>
                      <small class="text-muted float-end">Edite new products</small>
                      @if ($errors->any())
            ...
            <form action="{{ route('updateproduct')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="productquantity"  name="productquantity" value="{{ $productinfo->productquantity }}"  />
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <textarea
                                ...
                                value="{{ $productinfo->product_short_des }}"
