                    ...
                    <div class="card-body">
                      ...
                      <form action="" method="POST">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="productname"  name="productname" placeholder="Leptop" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="productprice"  name="productprice" placeholder="$10" />
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-select" id="category" name="categogry" aria-label="selecet this Menu">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-select" id="category" name="categogry" aria-label="select this Menu">
                                  <option selected>Open this select menu</option>
                                  <option value="1">One</option>
                                  <option value="2">Two</option>
                                  <option value="3">Three</option>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="file" class="form-control" id="formFile"  name="productprice" placeholder="$10" />
                            </div>
                          </div>
