    ...
    <div id="wrapper" >
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admindashboard')}}">
                ...
                <div class="sidebar-brand-text mx-3">Eco-Admin</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('allsubcategory')}}"> All Sub Category</a>
                    </div>
                </div>
            </li> 
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('pendingorders')}}">Pending Orders</a>
                        <a class="collapse-item" href="{{route('completeorders')}}">Completed Orders</a>
                        <a class="collapse-item" href="{{route('cancelorders')}}">Cancel Orders</a>
                    </div>
                </div>
            </li> 
